<!-- Today's Schedule -->
<div
    class="w-full flex flex-col min-h-[218px] md:min-h-[318px] lg:min-h-[506px] bg-[#F8F9FC] rounded-[4px] pt-[28px] gap-[20px]"
>
    ...
    <div class="flex flex-col w-full">
        ...
        <div class="w-full flex gap-[16px] md:gap-[24px] items-center py-[16px] bg-[#EDF0F6]">
            <div class="flex-1 max-w-[33%] md:max-w-[30%] font-semibold text-[12px] md:text-[14px] text-[#4F4F4F] flex items-center gap-[4px] pl-[24px]">
                <p>Employee</p>
            </div>

            <div class="flex-1 max-w-[25%] font-semibold text-[12px] md:text-[14px] text-[#4F4F4F] flex items-center gap-[4px] pl-[10px]">
                <p>Scheduled</p>
            </div>

            <div class="flex-1 font-semibold text-[12px] md:text-[14px] text-[#4F4F4F] flex items-center gap-[4px] pl-[10px]">
                <p>Status</p>
            </div>
        </div>
