        ...
        <div>
            ...
            <div class="px-4 py-2 my-4 bg-white-0 rounded-xl">
                ...
                @csrf
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <button type="button" onclick="toggleCsvUpload()" class="bg-gray-50 rounded">
                    ...
                    <div class="hidden" id="csv_upload">
                        <div onclick="openFolder()" id="csv-dropzone"
                            ...
                            <div class="flex space-x-2 items-center">
                                ...
                                <div class="flex flex-col ">
                                    ...
                                    <span
                                        class="text-[#A7A7A7] group-hover:text-[#3984E6] md:text-sm text-xs font-medium">
                        ...
                        <div class="border border-dotted rounded-lg bg-[#FAFAFA] p-4 mt-4">
                            ...
                            <div class="flex items-center justify-center">
                                <button class="bg-[#3984E6] text-white-0 py-1 md:w-[10%] w-[90%] rounded my-4" type="submit">Import</button>
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <div class="px-4 py-2 my-4 bg-white-0 rounded-lg">
                <div class="flex justify-between items-center">
                    ...
                    <button type="button" onclick="toggleManualUpload()" class="bg-gray-50 rounded">
...
{{--                        <form action="{{route('company.employee.store.manual')}}" method="POST" autocomplete="off" enctype="multipart/form-data">--}}
                            ...
                            <div class="w-full px-4 flex justify-end mt-2">
                                <button onclick="addManualEmployee()" type="button"
...
{{--                                </div>--}}
{{--                                <div class="w-full px-4 flex justify-end mt-2">--}}
{{--                                    <button onclick="addManualEmployee()" class="text-[#1A73E8] text-sm font-semibold underline">--}}
{{--                                        + Add another employee--}}
{{--                                    </button>--}}
{{--                                </div>--}}
{{--                            </div>--}}
...
<script>
    ...
    function toggleManualUpload() {
        let csv = document.getElementById("csv_upload");
        ...
        let csvClose = document.getElementById('csv_upload_close')
        let csvOpen = document.getElementById('csv_upload_open')
    ...
    function toggleCsvUpload() {
        let manual = document.getElementById("manual_upload");
        let element = document.getElementById("csv_upload");
        let close = document.getElementById('csv_upload_close')
        let open = document.getElementById('csv_upload_open')

        let manualClose = document.getElementById('manual_upload_close')
        let manualOpen = document.getElementById('manual_upload_open')
