    ...
    <div class="flex flex-col gap-[12px]">
      <div class="flex flex-col gap-[4px]">
        ...
        >
          ...
          >
            <div
              data-multiselect-selected="employee-select"
              class="h-full hidden items-center gap-[4px] px-[12px]"
            ></div>

            <div
              data-multiselect-default="employee-select"
              class="w-full h-full flex items-center justify-between pl-[24px] pr-[10px]"
            >
              <p class="font-medium text-[11px] text-[#A7A7A7]">Select</p>
              ...
              >
                <path
                  d="M3.30771 7.0583C3.36575 7.00019 3.43469 6.95409 3.51056 6.92263C3.58643 6.89118 3.66776 6.87499 3.7499 6.87499C3.83203 6.87499 3.91336 6.89118 3.98924 6.92263C4.06511 6.95409 4.13404 7.00019 4.19208 7.0583L9.9999 12.8669L15.8077 7.0583C15.925 6.94102 16.084 6.87514 16.2499 6.87514C16.4157 6.87514 16.5748 6.94102 16.6921 7.0583C16.8094 7.17557 16.8752 7.33463 16.8752 7.50048C16.8752 7.66634 16.8094 7.8254 16.6921 7.94267L10.4421 14.1927C10.384 14.2508 10.3151 14.2969 10.2392 14.3283C10.1634 14.3598 10.082 14.376 9.9999 14.376C9.91776 14.376 9.83643 14.3598 9.76056 14.3283C9.68469 14.2969 9.61575 14.2508 9.55771 14.1927L3.30771 7.94267C3.2496 7.88463 3.2035 7.8157 3.17205 7.73982C3.14059 7.66395 3.12441 7.58262 3.12441 7.50048C3.12441 7.41835 3.14059 7.33702 3.17205 7.26115C3.2035 7.18527 3.2496 7.11634 3.30771 7.0583Z"
                  fill="#828282"
                />
              </svg>
            </div>
          ...
          <div
            id="employee-select"
            class="hidden w-full max-h-[262px] overflow-y-auto"
          >
          @forelse ($employees as $employee)
            <label
              for="{{$employee->uuid}}"
              class="w-full h-[50px] px-[12px] flex items-center gap-[12px] border-t-[0.5px] border-[#EDEFF4]"
            >
              <input
                type="checkbox"
                id="{{$employee->uuid}}"
              ...
              <div class="flex-1 flex items-center gap-[4px]">
                <img
                  src="{{asset('user.jpg')}}"
                  class="w-[28px] h-[28px] rounded-full object-cover flex-shrink-0"
                  alt=""
                />

                <div
                  class="font-semibold text-[12px] text-[#4F4F4F] leading-none"
                >
                  <p>{{$employee->getFullNameAttribute()}}</p>

                  <p class="font-medium text-[8px] text-[#80868C]">
                    {{$employee->email}}
                  </p>
                </div>
              </div>
        ...
        <p
          data-multiselect-totalselected="employee-select"
          class="block font-semibold text-[12px] text-[#1A73E8]"
        ></p>
      </div>
